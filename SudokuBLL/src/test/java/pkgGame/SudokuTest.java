...
/*	private void PrintStars() {
	...
	@Test
	public void Sudoku_FullPuzzle_Easy()
	{
		try {
			Sudoku s1 = new Sudoku(9,pkgEnum.eGameDifficulty.get(100));
			s1.PrintPuzzle();
			assertTrue(s1.isSudoku());
	...
	@Test
	public void Sudoku_FullPuzzle_Hard()
	{
		try {
			Sudoku s1 = new Sudoku(9,pkgEnum.eGameDifficulty.get(1000));
			s1.PrintPuzzle();
			assertTrue(s1.isSudoku());
